...
import com.lojaIsac.Loja_Isac.model.Permissao;
import com.lojaIsac.Loja_Isac.repository.FuncionarioRepository;
import com.lojaIsac.Loja_Isac.repository.PapelRepository;
import com.lojaIsac.Loja_Isac.repository.PermissaoRepository;
...
public class PermissaoController {
	...
	public ModelAndView listar() {
		...
		return mv.addObject("listaPermissoes", permissaoRepository.findAll());
	}
